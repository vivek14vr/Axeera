...
import {
  webPricingIntro,
  webPricingPlans,
} from "@/lib/constants/web-pricing";
...
export function WebsitePricingSection() {
  return (
    <>
      <PageHeroSection
        eyebrow={webPricingIntro.heroEyebrow}
      ...
      <ScrollSection className="pb-20 sm:pb-24">
        <Container>
          <SectionHeading
            eyebrow={webPricingIntro.eyebrow}
            title={webPricingIntro.title}
            description={webPricingIntro.description}
            align="center"
          />
            ...
            {webPricingPlans.map((plan) => (
              ...
              >
                ...
                <div className="min-h-[6rem]">
                  ...
                  <p className="mt-1 text-sm font-medium text-muted">one-time</p>
                </div>
