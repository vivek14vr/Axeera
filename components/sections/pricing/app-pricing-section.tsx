...
import {
  appPricingIntro,
  appPricingPlans,
} from "@/lib/constants/app-pricing";
...
export function AppPricingSection() {
  return (
    <>
      <PageHeroSection
        eyebrow={appPricingIntro.heroEyebrow}
      ...
      <ScrollSection className="pb-20 sm:pb-24">
        <Container>
          <SectionHeading
            eyebrow={appPricingIntro.eyebrow}
            title={appPricingIntro.title}
            description={appPricingIntro.description}
            align="center"
          />
            ...
            {appPricingPlans.map((plan) => (
              ...
              >
                ...
                <div className="min-h-[6rem]">
                  ...
                  <p className="mt-1 text-sm font-medium text-muted">per project</p>
                </div>
                    ...
                    <div key={`${plan.id}-${section.title}`}>
                      ...
                      <ul className="mt-3 space-y-2.5">
                        {section.items.map((item) => (
                          <li
                            key={`${plan.id}-${section.title}-${item}`}
                            className="flex gap-2 text-sm leading-6 text-foreground/90"
                          >
                            <CheckIcon />
